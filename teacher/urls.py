...
urlpatterns = [
    url(r'^(?P<user_id>\d+)/$', views.index, name='index'), #change back
    ...
    url(r'^(?P<user_id>\d+)/timetable/', views.timetable, name= "timetable"),
    url(r'^(?P<user_id>\d+)/manage_lessons/', views.manage_lessons, name="manage_lessons"),
